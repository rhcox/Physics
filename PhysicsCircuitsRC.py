...
def HEAD(f,nn):
    ...
    f.write('\\title{Physics RC Circuit Quiz}\n')
    f.write('\\author{Reduce to equivilent circuit, solve the original circuit}\n')
    f.write('\\date{DUE April 17 }\n')
    f.write('\\maketitle\n')
...
def PAGE(f,a):
    random.seed(a)
    f.write('Draw schematics of reduced circuit, starting by reduing the capacitor. Draw the equivilent cirucuit, solve for current.\n\n')
    ...
    R4=random.randint(60,150)
    R4S=str(R4)
    
    R5=random.randint(300,300)
    R5S=str(R5)

    R6=random.randint(2,9)
    R6S=str(R6)
    ...
    f.write('(0,0)to[battery=$'+volts+'v$] (0,3)\n')
    f.write('(6,0)to[R=$'+RS+'\ \Omega$,-*] (6,3)\n')
    f.write('(3,0)to[C=$'+R6S+' \\mu F$,-*] (3,3)\n')
    ...
    f.write('\\item { \n\n \\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+volts+'v$] (0,3)\n')
    f.write('(6,0) to [R=$'+R1S+'\ \Omega$,-*] (6,3)\n')
    f.write('(0,3)to[C=$'+R6S+' \\mu F$,-*] (6,3)\n')
    f.write('(0,0)to[short] (6,0)\n')
    f.write('(0,3)to[short] (6,3)\n')
    f.write(';\n\n \end{circuitikz} \n  }\n')
    ...
    f.write('\\item { \n\n \\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+volts+'v$] (0,3)\n')
    f.write('(0,3) to [R=$'+R1S+'\ \Omega$,-*] (3,3)\n')
    f.write('(6,0) to [R=$'+R2S+'\ \Omega$,-*] (6,3)\n')
    f.write('(0,0)to[C=$'+R6S+' \\mu F$,-*] (4,0)\n')
    f.write('(0,0)to[short] (6,0)\n')
    f.write('(3,3)to[short] (6,3)\n')
    f.write(';\n\n \end{circuitikz} \n  }\n')
    ...
    f.write('\\item { \n\n \\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+volts+'v$] (0,4)\n')
    f.write('(3,4) to [R=$'+R6S+'\ \Omega$,-*] (3,2)\n')
    f.write('(6,4) to [R=$'+R5S+'\ \Omega$,-*] (6,0)\n')
    f.write('(3,0)to[C=$'+R6S+' \\mu F$,-*] (3,2)\n')
    f.write('(0,0)to[short] (6,0)\n')
    ...
    f.write('\\item { \n\n \\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+volts+'v$] (0,4)\n')
    f.write('(0,4) to [R=$'+R6S+'\ \Omega$,-*] (3,4)\n')
    f.write('(3,4) to [R=$'+RS+'\ \Omega$,-*] (3,0)\n')
    f.write('(6,4) to [R=$'+RS+'\ \Omega$,-*] (6,0)\n')
    f.write('(3,4)to[C=$'+R6S+' \\mu F$,-*] (6,4)\n')
    f.write('(0,0)to[short] (6,0)\n')
    f.write('(3,4)to[short] (6,4)\n')
    f.write(';\n\n \end{circuitikz} \n  }\n')
