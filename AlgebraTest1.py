...
def HEAD(f,n):
    ...
    f.write('\\title{Algebra II Quiz 2 }\n')
    f.write('\\author{RH Cox}\n')
    f.write('\\date{DATE: 2015 September 30 }\n')
    f.write('\\maketitle\n')
...
def PAGE(f,a):
    ...
    f.write('\\item Graph each function. Sketch the graph. State the expression and name of the parent function. State the Domain and Range. State the Transformation. \n')
    ...
    f.write('\\item $f('+v+')='+ms+v+'^2+'+bs+ '$ \n ')
    FILL(f)

    f.write('\\item $f('+v+')='+pm+cs+v+'^2+'+bs+ '$ \n ')
    FILL(f)

    f.write('\\item $f('+v+')=('+v+'+'+bs+ ')^2$ \n ')
    FILL(f)

    f.write('\\item $f('+v+')='+pm+'('+v+'+'+es+ ')^2$ \n ')
    FILL(f)

    f.write('\\item $f('+v+')=\sqrt{'+v+'+'+bs+'}$ \n ')
    FILL(f)

    f.write('\\item $f('+v+')='+pm+'\sqrt{'+es+v+'}$ \n ')
    FILL(f)

    f.write('\\end{enumerate}\n')
    

    f.write('\\item Write an expression for a quadritic function that is reflected and translated '+ms+' units on the '+axis+' axis.\n ')
