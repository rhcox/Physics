...
def PAGE(f,a):
    ...
    f.write('1.Simplify the circuit.\n\n')
    f.write('2.calculate all currents and voltages.\n\n')
    f.write('3.Draw in computer and confirm.\n\n')
    f.write('\\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+v+'v$] (0,6)\n')
    f.write('(0,6) to [R=$'+r1+'\\Omega$,-*] (4,6)\n')
    f.write('(4,0) to [R=$'+r2+'\\Omega$,-*] (4,4)\n')
    f.write('(4,4) to [R=$'+r3+'\\Omega$,-*] (4,6)\n')
    f.write('(8,0) to [R=$'+r4+'\\Omega$,-*] (8,4)\n')
    f.write('(8,4) to [R=$'+r5+'\\Omega$,-*] (8,6)\n')
    f.write('(12,0) to [R=$'+r6+'\\Omega$,-*] (12,6)\n')
    f.write('(4,0) to [R=$'+r7+'\\Omega$,-*] (8,0)\n')
    f.write('(0,0)to[short] (5,0)\n')
    f.write('(8,0)to[short] (12,0)\n')
    f.write('(4,6)to[short] (12,6)\n')
    f.write(';\n')
