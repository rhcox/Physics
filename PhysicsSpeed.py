...
def PAGE(f,a):
    ...
    f.write('\n A cart is traveling down a staight flat track. \n')
    ...
    f.write('\\item Using the slope of the best fit line, calculate the average speed of the cart between 0-12 seconds. \n')
