...
def HEAD(f):
	...
	f.write('\\title{Calculus Product Rule Quiz}\n')
...
def PAGE(f,a):
    ...
    f.write('\\item $\\frac{d}{dx} \\; '+t+'(x)$\n')
    f.write('\\newpage')
    v=str(random.randint(2,20))
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; \\frac{1}{x^{'+v+'}}+'+t+'(x)$\n')
    v=str(random.randint(2,20))
    w=str(round(random.random()*10,2))
    x=str(random.randint(2,20))
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; \\frac{'+w+'}{x^{'+v+'}}+'+t+'(x)$\n')
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; x'+t+'(x)$\n')
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    s=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; '+t+'(x)'+s+'(x)$\n')
    w=str(round(random.random()*10,2))
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; '+w+t+'(x)$\n')
    v=str(random.randint(2,20))
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; x^{'+v+'}'+t+'(x)$\n')
    v=str(random.randint(2,20))
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    f.write('\\item $\\frac{d}{dx} \\; \\frac{'+t+'(x)}{ x^{'+v+'}} $\n')
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    v=random.choice(['5','6','7','8', '9'])
    f.write('\\item $\\frac{d}{dx} \\; '+t+'(x) \\sqrt['+v+']{x}$\n')
    t=random.choice(['sin','cos','tan', 'sec', 'csc'])
    v=random.choice(['5','6','7','8', '9'])
    f.write('\\item $\\frac{d}{dx} \\; \\frac{'+t+'(x)}{ \\sqrt['+v+']{x}}$\n')
