...
def HEAD(f,n):
    ...
    f.write('\\title{POE Complex Circuits}\n')
...
def PAGE(f,a):
    ...
    f.write('1.Draw circuit in Simulator, including a switch and ammeters in the appropriated places.\n\n')
    f.write('2. Read current from the ammeters and write in the circuit at the correct locations using corret untis.\n\n')
    f.write('3. Use voltmeter to measure voltages across the risistors and write in correct location using correct polarity and units.\n\n')
    f.write('4. Use the battery voltage and the current going through the batter to calculate the equivelent resistance using Ohms Law.\n\n')
    f.write('5. Draw a circuit with the battery, the equalivelent resistance, and the current.\n\n')  
    f.write('\\begin{circuitikz}\draw\n')
    f.write('(0,0)to[battery=$'+v+'v$] (0,8)\n')
